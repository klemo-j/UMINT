...
<h2>🛠️ 5. Experiment: Vplyv parametra Dropout na pretrénovanie</h2>
<p>
  Pre analýzu vplyvu regularizácie (Dropout) na bod pretrénovania bola vybraná štruktúra <strong>Ľahká CNN</strong>. Modely boli opakovane trénované s rôznymi pravdepodobnosťami vypustenia neurónov (0.0, 0.3, 0.5 a silný dropout 0.7).
</p>
...
<table border="1" cellpadding="8" cellspacing="0" align="center">
  ...
  <tbody>
    <tr>
      ...
      <td align="center" style="color: red;">62.6</td>
    ...
    <tr>
      <td align="center" style="background-color: #e6ffec;"><strong>D4</strong></td>
      <td align="center" style="background-color: #e6ffec;"><strong>0.7</strong></td>
      <td align="center" style="background-color: #e6ffec;"><strong>5</strong></td>
      <td align="center" style="background-color: #e6ffec; color: green;"><strong>193.0</strong></td>
      <td align="center" style="background-color: #e6ffec;"><strong>0.0230</strong></td>
    </tr>
  </tbody>
</table>
<p align="center"><em>Tabuľka: Porovnanie bodu pretrénovania pre rôzne nastavenia dropout-u.</em></p>
...
<table border="1" cellpadding="8" cellspacing="0" align="center">
  ...
  <tbody>
    ...
    <tr>
      <td align="center" style="background-color: #e6ffec;"><strong>0.7</strong></td>
      <td align="center" style="background-color: #e6ffec;"><strong>5</strong></td>
      <td align="center" style="background-color: #e6ffec;"><strong>99.74</strong></td>
      <td align="center" style="background-color: #e6ffec;"><strong>99.26</strong></td>
      <td align="center" style="background-color: #e6ffec;"><strong>0.0230</strong></td>
    </tr>
  </tbody>
</table>
<p align="center"><em>Tabuľka: Súhrnné porovnanie úspešnosti pre rôzne nastavenia dropout-u.</em></p>

<p>
  <strong>Zhodnotenie:</strong> Výsledky jasne preukázali, že správne nastavenie dropoutu je kritické pre schopnosť siete generalizovať. Pri úplnom vypnutí dropoutu (0.0) sa sieť naučila dáta naspamäť najrýchlejšie (pretrénovanie už na 62. iterácii) s najhoršou testovacou úspešnosťou. Následné zvyšovanie dropoutu malo pozitívny vplyv, avšak najviac prekvapivým zistením bol <strong>extrémne silný dropout na úrovni 0.7</strong>. Namiesto deštrukcie naučených vzorov fungoval ako ultimátny regularizátor – pretrénovanie sa oddialilo až na úroveň <strong>193. iterácie</strong> a model dosiahol celkovo najlepšiu testovaciu úspešnosť (99.26 %) aj najnižšiu chybovosť.
</p>
...
<h2>🖼️ 6. Ukážky úspešnej klasifikácie</h2>
<div align="center">
